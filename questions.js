const questions = [
...

    {
        ...
        passage:
            `<h4>Long Passage</h4><br><p>Early studies of urban tree planting emphasized its aesthetic benefits. Trees, researchers argued, improved the visual character of 
